...
from image_sources.provider_common import (
    ...
    cjk_locale_params,  # D19 FR6.2 (PPT Engine local patch)
...
def search(
    ...
    *,
    ...
    for query in build_query_progression(request.query):
        ...
        # D19 FR6.2 (PPT Engine local patch): tell Pexels the query language
        # for CJK queries (locale=zh-CN); English queries stay untouched.
        params.update(cjk_locale_params("pexels", query))
