...
from image_sources.provider_common import (
    ...
    openverse_auth_headers,  # D19 FR6.4 (PPT Engine local patch)
)
...
def search(
    ...
    *,
    ...
    for query in build_query_progression(request.query):
        ...
        # D19 FR6.4 (PPT Engine local patch): attach OAuth bearer when
        # OPENVERSE_CLIENT_ID/SECRET are configured (rate-limit uplift over
        # the anonymous 20/min · 200/day caps); anonymous otherwise.
        headers = {"User-Agent": USER_AGENT, "Accept": "application/json"}
        headers.update(openverse_auth_headers())
