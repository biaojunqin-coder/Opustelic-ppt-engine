...
def search(
    ...
    *,
    ...
    for query in build_query_progression(request.query):
        ...
        # D19 FR6.2 (PPT Engine local patch): tell Pixabay the query language
        # for CJK queries (lang=zh); English queries stay untouched.
        params.update(cjk_locale_params("pixabay", query))
