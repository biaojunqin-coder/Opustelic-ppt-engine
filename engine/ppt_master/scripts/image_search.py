...
def _load_search_env_file() -> None:
    ...
    D19 FR6.4 (PPT Engine local patch): also load OPENVERSE_CLIENT_ID /
    OPENVERSE_CLIENT_SECRET so the optional Openverse OAuth uplift
    (image_sources.provider_common.openverse_auth_headers) can be configured
    from the same shared .env as the keyed providers.
    """
    load_prefixed_env_file(("PEXELS_", "PIXABAY_", "OPENVERSE_"))
